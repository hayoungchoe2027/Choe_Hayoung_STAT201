...
results <- my_function(60, 160)
paste("Your BMI is", results, "with a value of", paste0(BMI, "."))
```
...
```{r}
results <- sapply(list_object, sum)
for (i in results) {
  if (i %% 2 == 0) {
    print(TRUE)
  } else{
...
for (i in 1:nrow(fruit_info)) {
  if (fruit_info[["weight"]] > 100) {
    print(paste("The", fruit_info[["fruit"]], "is heavy."))
  } else {
    print(paste("The", fruit_info[["fruit"]], "is light."))
  }
}
```
